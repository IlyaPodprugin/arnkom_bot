...
# from config import greeting, first_question_txt
...
#     all_questions = []
#
#     def __init__(self, number, text, __type__, answers=4):
#         self.number = number
#         self.text = text
...
#
#     @bot.send_message()
#     def generate_question_message(self, message):
#         keyboard = types.InlineKeyboardMarkup()
#         buttons = []
#         button = types.InlineKeyboardButton(text=first_question_txt, callback_data="ready")
#         keyboard.add(*buttons)
#         return bot.send_message(chat_id, self.text, reply_markup=keyboard)
#
#
